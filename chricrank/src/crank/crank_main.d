...
void chatBranch() {
    ...
    cp!sendUlineChatBreed_chat_binact.load(statCid!sendConceptToBranch_stat, uline_breed, chatBreed_hardcid_breed);
    cp!sendUlineUserTid_chat_binact.load(statCid!sendConceptToBranch_stat, uline_breed, userThread_hardcid_tidprem);
...
void ulineBranch() {
    ...
    cp!sendUserUlineTid_uline_binact.load(statCid!sendTidToUser_stat, userThread_hardcid_tidprem, uline_breed);
    ...
    cp!sendUserRequestForNextLine_uline_unact.load(statCid!requestUserInput, userThread_hardcid_tidprem);
