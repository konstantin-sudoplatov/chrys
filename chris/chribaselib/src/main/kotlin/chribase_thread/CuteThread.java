...
import static chribase.Base_dataKt.DEFAULT_MAX_THREAD_QUEUE;
import static chribase.Base_dataKt.DEFAULT_THREAD_QUEUE_TIMEOUT;
import static chribase.Base_funcsKt.logit;
...
public class CuteThread extends Thread {
     ...
     * chribase.DEFAULT_MAX_THREAD_QUEUE limit.
     * @param msg message.
     */
