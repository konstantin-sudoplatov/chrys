 ...
 * the uline branch, which sends the dispacher its ownBrid. Dispatcher stores the ownBrid along with the console thread reference
 * in its map and forwards the ownBrid to console. Since then the console talks to the circle directly, bypassing the dispatcher.
 *
