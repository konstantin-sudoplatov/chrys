 ...
 * @author su
 */
public class AddCloneOfElementToList extends StaticAction {
    ...
    public long[] go(ConceptNameSpace nameSpace, long[] paramCids, Object extra) {
        ...
        // Get params
        List lst = (List)nameSpace.get_cpt(paramCids[0]);
        Concept elem = nameSpace.get_cpt(paramCids[1]);     // just to check that the concept exists
        
        // Clone the element
        CloneConcept cloneCpt = (CloneConcept)nameSpace.get_cpt(StatCptName.CloneConcept.name());
